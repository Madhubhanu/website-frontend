...
const DashboardSearch = ({ onSelectPatient, fetchDataFromAPIs, selectedBatch, setSelectedBatch }) => {
  ...
  const fetchBatches = async () => {
    try {
      const response = await fetch(`https://website-backend-r1z2.onrender.com/get-batches`);
  ...
  const toggleAvailability = async (event, patient) => {
    ...
    try {
      const response = await fetch("https://website-backend-r1z2.onrender.com/update-availability", {
        method: "POST",
